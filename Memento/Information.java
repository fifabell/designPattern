...
public class Information {
    ...
    public MementoClass CreateMemento()                    //Memento를 생성합니다 (상태저장) 
    {
        return new MementoClass(this.Data1,this.Data2);
    }

    public void RestorMemento(MementoClass memento)         //Memento를 복원합니다 (상태복원)
    {
